      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 mx-auto max-w-3xl border border-white border-opacity-20 shadow-xl">
              ...
              <p className="text-gray-100">
                ...
                is essential for career success. Get your internship opportunity
                with India's top companies.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="https://services.cehpoint.co.in/careers/">
              <Button
                variant="ghost"
                className="px-8 py-4 text-white border-2 border-white/30 hover:border-white/60 hover:bg-white/10 text-lg font-semibold rounded-full backdrop-blur-sm transition-all duration-300"
              >
