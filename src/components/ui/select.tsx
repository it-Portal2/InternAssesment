  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-gray-900 text-white border border-gray-700 rounded-lg shadow-xl shadow-black/50 z-50 overflow-hidden",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded py-2 pr-8 pl-2 text-sm outline-none select-none transition-colors",
        "text-white hover:bg-yellow-500/20 focus:bg-yellow-500/20",
